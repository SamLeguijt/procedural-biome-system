...
public class WorldSettings : ScriptableObject
{
    ...
    [field: SerializeField] public AWorldGenerator WorldGenerator { get; private set; }
    [field: SerializeField] public ALayoutGenerator LayoutGenerator { get; private set; }
